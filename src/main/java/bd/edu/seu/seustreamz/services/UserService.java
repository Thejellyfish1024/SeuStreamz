...
import bd.edu.seu.seustreamz.interfaces.UserInterface;
    ...
    public List<User> getUsers() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                users.add(new User(name, email, password, profileImageUrl, currentSubscription, subscriptionHistoryList, watchHistoryList, favoritesList, createdAt));
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
